...
keymaps.set("t", "<A-Esc>", [[<C-\><C-n>]])
keymaps.set("i", "<S-Tab>", 'copilot#Accept("\\<S-Tab>")', { expr = true, replace_keycodes = false })
...
vim.keymap.set("n", "<leader>cl", function()
  ...
  if vim.tbl_isempty(lenses) then
    vim.notify("No CodeLens available here", vim.log.levels.INFO)
    return
  end
